...
def plugin():
    ...
    plugin_api.plugin.fonksiyon_ekle("kelime_say", kelime_say)
    plugin_api.plugin.fonksiyon_ekle("ters_cevir", ters_cevir)
    return {
