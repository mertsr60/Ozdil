...
"""
ozpip CLI (ozpip.py)
ÖzDil Paket Yöneticisi Komut Satırı Arayüzü.
"""
...
from ozdil.package_manager import (
    install_package,
    uninstall_package,
...
from ozdil.repository import get_repository_json, fetch_package_data

def show_help():
    print("=== ozpip - ÖzDil Paket Yöneticisi ===")
    print("Kullanım:")
    print("  python3 ozpip.py yükle <paket_adı>    (veya install)   -> Paketi kurar ve bağımlılıklarını çözer")
    print("  python3 ozpip.py kaldır <paket_adı>   (veya uninstall) -> Paketi sistemden kaldırır")
    print("  python3 ozpip.py liste                (veya list)      -> Kurulu paketleri listeler ve imza doğrular")
    print("  python3 ozpip.py bilgi <paket_adı>    (veya info)      -> Paket detaylarını görüntüler")
    print("  python3 ozpip.py güncelle <paket_adı> (veya update)    -> Paketi son sürüme günceller")
    print("  python3 ozpip.py ara <kelime>         (veya search)    -> Paket deposunda arama yapar")
    print("  python3 ozpip.py yardım               (veya help)      -> Bu menüyü gösterir")
